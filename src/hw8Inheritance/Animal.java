...
public class Animal {
	...
	/*Create a package name "hw8Inheritance" in HW project. Inside the package, 
	 ...
	 * Now extends BullDog, Cobra, and Robin class to their parents class and shows their hierarchy till Animal Class, 
	 ...
	 * Also, show by java comments who is Parent class and who is child class for at least one class. Organize the code. 
